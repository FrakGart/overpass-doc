...
The level of detail is specified by the out command combined with one or more parameters. there is a hierarchy to enable them:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc0MTIyMDIzMSwxNzg2MTUwMjc3LDcxOD
c3NDM3OF19
-->